      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        <div className="max-w-4xl mx-auto space-y-8">
          <section className="space-y-4">
            <h1 className="text-4xl font-bold text-secondary">About EchoVerse</h1>
            <p className="text-lg text-secondary/80">
              EchoVerse is a powerful audio and video transcription platform that leverages cutting-edge AI technology to transform your media into actionable insights.
            </p>
          </section>
